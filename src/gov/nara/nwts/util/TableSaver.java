...
/**
 * Exports the contents of a table to a tab-separated file
 * @author TBrady
 *
 */
public class TableSaver extends JDialog {
	...
	AnalyzeSammaGui parent;
    public TableSaver(AnalyzeSammaGui parent, DefaultTableModel tm, JTable jt, String fname) {
    	this(parent, tm, jt, fname, new ArrayList<String>());
    }
    TableSaver(AnalyzeSammaGui parent, DefaultTableModel tm, JTable jt, String fname, List<String>noExport) {
    	super(parent, "Export Table: "+fname);
    	this.tm = tm;
    	this.parent = parent;
    	this.jt = jt;
